<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="{{ asset('images/icons/icon-logo.svg') }}" class="navbar-brand-img h-100" alt="logo"
                width="20px">
            <span class="ms-3 font-weight-bold">Punto de venta</span>
        </a>
    </div>
    <hr class="horizontal dark mt-0">

    {{-- Menu lateral izquierdo --}}
    {{-- <div class="collapse navbar-collapse" id="sidenav-collapse-main"> este es para el scroll del menu izquierdo --}}
    <div>
        <ul class="navbar-nav">
            <li class="nav-item">
            ...
            {{-- Tabla de categorias --}}
            <li class="nav-item">
                <a class="nav-link {{ Request::is('mostrar-categorias') ? 'active' : '' }} "
                    href="{{ route('mostrar-categorias') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('images/icons/icon-category.svg') }}" alt="categoria" width="15px"></img>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('mostrar-subcategorias') ? 'active' : '' }}"
                    href="{{ route('mostrar-subcategorias') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('mostrar-productos') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('images/icons/icon-producto.svg') }}" alt="producto" width="15px">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('mostrar-marcas') ? 'active' : '' }} "
                    href="{{ route('mostrar-marcas') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('images/icons/icon-marca.svg') }}" alt="marca" width="15px">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('mostrar-clientes') ? 'active' : '' }} "
                    href="{{ route('mostrar-clientes') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('images/icons/icon-cliente.svg') }}" alt="cliente" width="15px">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('mostrar-proveedores') ? 'active' : '' }} "
                    href="{{ route('mostrar-proveedores') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('images/icons/icon-proveedor.svg') }}" alt="proveedor" width="15px">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('') ? 'active' : '' }} " href="">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('images/icons/icon-recibo.svg') }}" alt="recibo" width="15px">
                    </div>
