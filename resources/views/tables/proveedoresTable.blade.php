                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-2">
                            <div class="d-flex justify-content-between align-items-center mx-4">
                                ...
                                <div class="d-flex justify-end">
                                    ...
                                    <a href="{{ route('registrar-proveedor-form') }}" class="btn bg-gradient-primary mt-4">
                                        <img src="{{ asset('images/icons/icon-add.svg') }}" alt="add"
                                            width="30px">Agregar proveedores
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table id="proveedores-table" class="table align-items-center mb-0 text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn bg-gradient-info mt-3"
                                                        ...
                                                        data-bs-target="#modal-edit-{{ $proveedor->id }}">
                                                ...
                                                <td>
                                                    <button type="button" class="btn bg-gradient-danger mt-3"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modal-default-{{ $proveedor->id }}">
...
@push('modals')
    @foreach ($proveedores as $proveedor)
        <!-- The Modal delete -->
        <div class="modal fade" id="modal-default-{{ $proveedor->id }}" tabindex="-1" role="dialog"
            aria-labelledby="modal-default-{{ $proveedor->id }}" aria-hidden="true">
            <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="modal-title-default-{{ $proveedor->id }}">¿Estás seguro de eliminar al
                            proveedor
                            <span class="modal-edit-name">{{ $proveedor->nombre_proveedor }}</span>?
                        </h6>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('eliminar-proveedor', $proveedor->id) }}" method="POST">
                            @csrf
                            @method('delete')
        ...
        {{-- Modal para editar --}}
        <div class="modal fade" id="modal-edit-{{ $proveedor->id }}" tabindex="-1" role="dialog"
            aria-labelledby="modal-edit-{{ $proveedor->id }}" aria-hidden="true">
            <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="modal-title-edit-{{ $proveedor->id }}">¿Seguro qué quieres editar
                            el proveedor <span class="modal-edit-name">{{ $proveedor->nombre_proveedor }}</span>?
                        </h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('editar-proveedor-update', $proveedor->id) }}">
